...
export async function registerUser(req, res){
    try{
        ...
        console.error("An AggregateError occurred! Printing individual failures:");
        err.errors.forEach((singleErr, index) => {
            console.error(`  Error #${index + 1}: ${singleErr.message}`);
        });
        console.log(`Some error happened-> ${err.message} and the error is ${err}`);
